...
function ngAdd(optionsFromCommandline) {
    return (host, context) => {
        ...
        const templateSource = schematics_1.apply(schematics_1.url('./files'), [
            schematics_1.template(Object.assign(Object.assign(Object.assign({}, schematics_core_1.stringUtils), options), { 'i18nLocale': options.i18nLocale, 'i18nFormat': options.i18nFormat })),
